...
def get_best_match_response(response, detected_text, publisher_list):
    ...
    string_closest_item_index = find_closest_titlestring(response, detected_text)
    publisherclosest_item_index = find_closest_publisherstring(response, detected_text, publisher_list)
    print(image_closest_item_index, string_closest_item_index, publisherclosest_item_index)
    lst = image_closest_item_index + string_closest_item_index + publisherclosest_item_index
